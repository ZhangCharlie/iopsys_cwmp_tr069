...
static int check_uci_datamodel(void)
{
    ...
    if ((strcasecmp(uci_datamodel, "tr098") == 0) || (strcasecmp(uci_datamodel, "tr-098") == 0))
        return DM_TR098;
...
int dm_entry_param_method(struct dmctx *ctx, int cmd, char *inparam, char *arg1, char *arg2)
{
    ...
    switch (cmd)
    {
        ...
        case CMD_SET_NOTIFICATION:
            ...
            if (!err && arg1
                && (strcmp(arg1, "0") == 0 || strcmp(arg1, "1") == 0 || strcmp(arg1, "2") == 0 || strcmp(arg1, "3") == 0 || strcmp(arg1, "4") == 0 || strcmp(arg1, "5") == 0 || strcmp(arg1, "6") == 0))
            {
