...
struct notification notifications[] = {
    [0] = {"0", "disabled"}, [1] = {"1", "passive"}, [2] = {"2", "active"}, [3] = {"3", "passive_lw"}, [4] = {"4", "passive_passive_lw"}, [5] = {"5", "active_lw"}, [6] = {"6", "passive_active_lw"}};
...
int dm_entry_add_object(struct dmctx *dmctx)
{
    ...
    if (dmctx->in_param == NULL || dmctx->in_param[0] == '\0' || (*(dmctx->in_param + strlen(dmctx->in_param) - 1) != dm_delim))
        return FAULT_9005;
