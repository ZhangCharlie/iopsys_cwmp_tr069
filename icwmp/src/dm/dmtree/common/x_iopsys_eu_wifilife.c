...
DMLEAF X_IOPSYS_EU_WiFiLifeParams[] = {{"Enable", &DMWRITE, DMT_BOOL, get_x_iopsys_eu_wifilife_enable, set_x_iopsys_eu_wifilife_enable, NULL, NULL}, {0}};

DMLEAF WiFiLifeSteeringParams[] = {{"Enable", &DMWRITE, DMT_BOOL, get_wifilife_steering_enable, set_wifilife_steering_enable, NULL, NULL},
