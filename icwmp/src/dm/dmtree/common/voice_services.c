...
struct cap_sip_codec   capabilities_sip_codecs[] = {{SIP_CODEC_G723, "g723", "G.723.1", "6451", "30-300", "30"},
...
struct region          capabilities_regions[]    = {{"AUS", "AU"}, {"BEL", "BE"}, {"BRA", "BR"}, {"CHL", "CL"}, {"CHN", "CN"}, {"CZE", "CZ"}, {"DNK", "DK"}, {"FIN", "FI"}, {"FRA", "FR"},
                                                    {"DEU", "DE"}, {"HUN", "HU"}, {"IND", "IN"}, {"ITA", "IT"}, {"JPN", "JP"}, {"NLD", "NL"}, {"NZL", "NZ"}, {"USA", "US"}, {"ESP", "ES"},
                                                    {"SWE", "SE"}, {"CHE", "CH"}, {"NOR", "NO"}, {"TWN", "TW"}, {"GBR", "GB"}, {"ARE", "AE"}, {"ETS", "ET"}, {"T57", "T5"}};
struct rtp_tos         list_rtp_tos[]            = {{"CS0", "0"},    {"CS1", "32"},   {"AF11", "40"},  {"AF12", "48"},  {"AF13", "56"},  {"CS2", "64"},   {"AF21", "72"},
                                                    {"AF22", "80"},  {"AF23", "88"},  {"CS3", "96"},   {"AF31", "104"}, {"AF32", "112"}, {"AF33", "120"}, {"CS4", "128"},
                                                    {"AF41", "136"}, {"AF42", "144"}, {"AF43", "152"}, {"CS5", "160"},  {"EF", "184"},   {"CS6", "192"},  {"CS7", "224"}};
    ...
    switch (action)
    {
        ...
        case VALUESET:
            if (strcasecmp(value, "udp") == 0)
                dmuci_set_value_by_section(sipargs->sip_section, "transport", "");
            else
                dmuci_set_value_by_section(sipargs->sip_section, "transport", value);
            return 0;
    }
