 ...
 * OPERATE COMMANDS
 *************************************************************/
static operation_args ip_diagnostics_ipping_args = {.in  = (const char *[]){"Interface", "ProtocolVersion", "Host", "NumberOfRepetitions", "Timeout", "DataBlockSize", "DSCP", NULL},
                                                    .out = (const char *[]){"Status",
                                                                            "IPAddressUsed",
                                                                            "SuccessCount",
                                                                            "FailureCount",
                                                                            "AverageResponseTime",
...
static int operate_IPDiagnostics_IPPing(char *refparam, struct dmctx *ctx, void *data, char *instance, char *value, int action)
{
    ...
    dmubus_call_blocking("bbf.diag",
                         "ipping",
                         UBUS_ARGS{{"host", ipping_host, String},
...
static operation_args ip_diagnostics_trace_route_args = {
    .in  = (const char *[]){"Interface", "ProtocolVersion", "Host", "NumberOfTries", "Timeout", "DataBlockSize", "DSCP", "MaxHopCount", NULL},
    .out = (const char *[]){"Status", "IPAddressUsed", "ResponseTime", "RouteHops.{i}.Host", "RouteHops.{i}.HostAddress", "RouteHops.{i}.ErrorCode", "RouteHops.{i}.RTTimes", NULL}};
...
static int operate_IPDiagnostics_TraceRoute(char *refparam, struct dmctx *ctx, void *data, char *instance, char *value, int action)
{
    ...
    snprintf(input,
             sizeof(input),
             "'{\"host\": "
             "\"%s\",\"iface\":\"%s\",\"ip_proto\":\"%s\",\"nbr_of_tries\":\"%s\",\"timeout\":\"%s\",\"data_size\":\"%s\",\"dscp\":\"%s\",\"max_hop_cnt\":\"%"
             "s\",\"proto\":\"%s\"}'",
             host,
             interface,
             ip_proto,
...
static operation_args ip_diagnostics_download_args = {.in  = (const char *[]){"Interface",
                                                                              "DownloadURL",
                                                                              "DSCP",
                                                                              "EthernetPriority",
...
static int operate_IPDiagnostics_DownloadDiagnostics(char *refparam, struct dmctx *ctx, void *data, char *instance, char *value, int action)
{
    ...
    if (strncmp(download_url, HTTP_URI, strlen(HTTP_URI)) != 0 && strncmp(download_url, FTP_URI, strlen(FTP_URI)) != 0 && strchr(download_url, '@') != NULL)
    {
    ...
    snprintf(input,
             sizeof(input),
             "'{\"url\": "
             "\"%s\",\"iface\":\"%s\",\"dscp\":\"%s\",\"eth_prio\":\"%s\",\"ip_proto\":\"%s\",\"num_of_con\":\"%s\",\"enable_per_con\":\"%s\",\"proto\":\"%s\"}'",
             download_url,
             download_interface,
             download_dscp,
...
static operation_args ip_diagnostics_upload_args = {.in  = (const char *[]){"Interface",
                                                                            "UploadURL",
                                                                            "DSCP",
                                                                            "EthernetPriority",
                                                                            "TestFileLength",
...
static int operate_IPDiagnostics_UploadDiagnostics(char *refparam, struct dmctx *ctx, void *data, char *instance, char *value, int action)
{
    ...
    if (strncmp(upload_url, HTTP_URI, strlen(HTTP_URI)) != 0 && strncmp(upload_url, FTP_URI, strlen(FTP_URI)) != 0 && strchr(upload_url, '@') != NULL)
        return USP_FAULT_INVALID_ARGUMENT;
    ...
    snprintf(input,
             sizeof(input),
             "'{\"url\": "
             "\"%s\",\"iface\":\"%s\",\"dscp\":\"%s\",\"eth_prio\":\"%s\",\"file_length\":\"%s\",\"ip_proto\":\"%s\",\"num_of_con\":\"%s\",\"enable_per_con\":"
             "\"%s\",\"proto\":\"%s\"}'",
             upload_url,
             upload_interface,
             upload_dscp,
...
static operation_args ip_diagnostics_udpecho_args = {
    .in  = (const char *[]){"Interface", "Host", "Port", "NumberOfRepetitions", "Timeout", "DataBlockSize", "DSCP", "InterTransmissionTime", "ProtocolVersion", "EnableIndividualPacketResults", NULL},
    .out = (const char *[]){"Status",
                            "IPAddressUsed",
                            "SuccessCount",
                            "FailureCount",
...
static int operate_IPDiagnostics_UDPEchoDiagnostics(char *refparam, struct dmctx *ctx, void *data, char *instance, char *value, int action)
{
    ...
    dmubus_call_blocking("bbf.diag",
                         "udpecho",
                         UBUS_ARGS{{"host", udpecho_host, String},
...
static operation_args ip_diagnostics_server_selection_args = {
    .in  = (const char *[]){"Interface", "ProtocolVersion", "Protocol", "HostList", "NumberOfRepetitions", "Timeout", NULL},
    .out = (const char *[]){"Status", "FastestHost", "MinimumResponseTime", "AverageResponseTime", "MaximumResponseTime", "IPAddressUsed", NULL}};
...
static int operate_IPDiagnostics_ServerSelectionDiagnostics(char *refparam, struct dmctx *ctx, void *data, char *instance, char *value, int action)
{
    ...
    dmubus_call_blocking("bbf.diag",
                         "serverselection",
                         UBUS_ARGS{{"hostlist", hostlist, String},
                                   {"port", port, String},
...
DMOBJ tIPDiagnosticsDownloadDiagnosticsObj[] = {
    ...
    {"PerConnectionResult",
     ...
     NULL,
     NULL,
     browseIPDiagnosticsDownloadDiagnosticsPerConnectionResultInst,
     NULL,
     NULL,
     NULL,
     tIPDiagnosticsDownloadDiagnosticsPerConnectionResultParams,
     NULL,
     BBFDM_CWMP},
    {0}};
...
DMOBJ tIPDiagnosticsUploadDiagnosticsObj[] = {
    ...
    {"PerConnectionResult",
     ...
     NULL,
     NULL,
     browseIPDiagnosticsUploadDiagnosticsPerConnectionResultInst,
     NULL,
     NULL,
     NULL,
     tIPDiagnosticsUploadDiagnosticsPerConnectionResultParams,
     NULL,
     BBFDM_CWMP},
    {0}};
