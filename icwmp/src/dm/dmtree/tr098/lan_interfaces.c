...
/*** LANInterfaces. ***/
DMOBJ tLANInterfacesObj[] = {{"LANEthernetInterfaceConfig", &DMREAD, NULL, NULL, NULL, browselaninterface_lanInst, NULL, NULL, NULL, tlaninterface_lanParam, NULL},
                             {"WLANConfiguration", &DMREAD, NULL, NULL, NULL, browselaninterface_wlanInst, NULL, NULL, NULL, tlaninterface_wlanParam, NULL},
                             {0}};

DMLEAF tLANInterfacesParam[] = {{"LANEthernetInterfaceNumberOfEntries", &DMREAD, DMT_UNINT, get_lan_ethernet_interface_number, NULL, NULL, NULL},
...
DMLEAF tlaninterface_lanParam[] = {
    {"Alias", &DMWRITE, DMT_STRING, get_lan_eth_int_alias, set_lan_eth_int_alias, NULL, NULL}, {CUSTOM_PREFIX "EthName", &DMREAD, DMT_STRING, get_eth_name, NULL, NULL, NULL}, {0}};

/*** LANInterfaces.WLANConfiguration. ***/
DMLEAF tlaninterface_wlanParam[] = {{"Alias", &DMWRITE, DMT_STRING, get_wlan_conf_alias, set_wlan_conf_alias, NULL, NULL}, {0}};
