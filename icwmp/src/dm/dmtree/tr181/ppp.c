...
DMLEAF tpppInterfaceParam[] = {{"Alias", &DMWRITE, DMT_STRING, get_ppp_alias, set_ppp_alias, NULL, NULL},
...
/*** PPP.Interface.Stats. ***/
DMLEAF tStatsParam[] = {{"BytesReceived", &DMREAD, DMT_UNINT, get_ppp_eth_bytes_received, NULL, NULL, NULL},
