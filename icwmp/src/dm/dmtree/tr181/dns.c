...
DMOBJ tDNSObj[] = {{"Client", &DMREAD, NULL, NULL, NULL, NULL, NULL, NULL, tClientObj, tClientParams, NULL},
...
DMLEAF tDNSParams[] = {{"SupportedRecordTypes", &DMREAD, DMT_STRING, get_dns_supported_record_types, NULL, NULL, NULL}, {0}};

DMLEAF tClientParams[] = {{"Enable", &DMWRITE, DMT_BOOL, get_client_enable, set_client_enable, NULL, NULL},
...
DMOBJ tClientObj[] = {{"Server", &DMWRITE, add_client_server, delete_client_server, NULL, browseServerInst, NULL, NULL, NULL, tServerParams, NULL}, {0}};

DMLEAF tServerParams[] = {{"Enable", &DMWRITE, DMT_BOOL, get_server_enable, set_server_enable, NULL, NULL},
...
DMLEAF tRelayParams[] = {{"Enable", &DMWRITE, DMT_BOOL, get_relay_enable, set_relay_enable, NULL, NULL},
...
DMOBJ tRelayObj[] = {{"Forwarding", &DMWRITE, add_relay_forwarding, delete_relay_forwarding, NULL, browseRelayForwardingInst, NULL, NULL, NULL, tForwardingParams, NULL}, {0}};

DMLEAF tForwardingParams[] = {{"Enable", &DMWRITE, DMT_BOOL, get_forwarding_enable, set_forwarding_enable, NULL, NULL},
...
DMOBJ tDiagnosticsObj[] = {{"NSLookupDiagnostics", &DMREAD, NULL, NULL, NULL, NULL, NULL, NULL, tNSLookupDiagnosticsObj, tNSLookupDiagnosticsParams, NULL}, {0}};

DMLEAF tNSLookupDiagnosticsParams[] = {{"DiagnosticsState", &DMWRITE, DMT_STRING, get_nslookupdiagnostics_diagnostics_state, set_nslookupdiagnostics_diagnostics_state, NULL, NULL},
...
DMOBJ tNSLookupDiagnosticsObj[] = {{"Result", &DMREAD, NULL, NULL, NULL, browseResultInst, NULL, NULL, NULL, tResultParams, NULL}, {0}};

DMLEAF tResultParams[] = {{"Status", &DMREAD, DMT_STRING, get_result_status, NULL, NULL, NULL},
