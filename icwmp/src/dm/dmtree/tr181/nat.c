...
DMLEAF tnatParam[] = {{"InterfaceSettingNumberOfEntries", &DMREAD, DMT_UNINT, get_nat_interface_setting_number_of_entries, NULL, NULL, NULL},
                      {"PortMappingNumberOfEntries", &DMREAD, DMT_UNINT, get_nat_port_mapping_number_of_entries, NULL, NULL, NULL},
                      {0}};

/*** NAT.InterfaceSetting. ***/
DMLEAF tInterfaceSettingParam[] = {{"Enable", &DMWRITE, DMT_BOOL, get_nat_interface_setting_enable, set_nat_interface_setting_enable, NULL, NULL},
...
/*** NAT.PortMapping. ***/
DMLEAF tPortMappingParam[] = {{"Enable", &DMWRITE, DMT_BOOL, get_nat_port_mapping_enable, set_nat_port_mapping_enable, NULL, NULL},
