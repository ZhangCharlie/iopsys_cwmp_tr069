...
DMOBJ tUsersObj[] = {{"User", &DMWRITE, add_users_user, delete_users_user, NULL, browseUserInst, NULL, NULL, NULL, tUserParams, NULL}, {0}};

DMLEAF tUsersParams[] = {{"UserNumberOfEntries", &DMREAD, DMT_UNINT, get_users_user_number_of_entries, NULL, NULL, NULL}, {0}};

DMLEAF tUserParams[] = {{"Alias", &DMWRITE, DMT_STRING, get_user_alias, set_user_alias, NULL, NULL},
