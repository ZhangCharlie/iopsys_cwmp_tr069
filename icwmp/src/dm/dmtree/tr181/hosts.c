...
DMLEAF thostsParam[] = {{"HostNumberOfEntries", &DMREAD, DMT_UNINT, get_host_nbr_entries, NULL, NULL, NULL}, {0}};

/*** Hosts.Host ***/
DMLEAF thostParam[] = {{"AssociatedDevice", &DMREAD, DMT_STRING, get_host_associateddevice, NULL, NULL, NULL},
