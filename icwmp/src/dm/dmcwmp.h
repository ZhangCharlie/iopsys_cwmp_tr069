...
#define DMPARAM_ARGS                                                                                                                                                                                   \
    struct dmctx *dmctx, struct dmnode *node, char *lastname, struct dm_permession_s *permission, int type,                                                                                            \
        int (*get_cmd)(char *refparam, struct dmctx *ctx, void *data, char *instance, char **value),                                                                                                   \
        int (*set_cmd)(char *refparam, struct dmctx *ctx, void *data, char *instance, char *value, int action), struct dm_forced_inform_s *forced_inform, struct dm_notif_s *notification, void *data, \
        char *instance

#define DMOBJECT_ARGS                                                                                                                                                                      \
    struct dmctx *dmctx, struct dmnode *node, struct dm_permession_s *permission, int (*addobj)(char *refparam, struct dmctx *ctx, void *data, char **instance),                           \
        int (*delobj)(char *refparam, struct dmctx *ctx, void *data, char *instance, unsigned char del_action), struct dm_forced_inform_s *forced_inform, struct dm_notif_s *notification, \
        int (*get_linker)(char *refparam, struct dmctx *dmctx, void *data, char *instance, char **linker), void *data, char *instance
